                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="nic_front_img" alt="" data-src="<?= isset($data->nic_front) ? base_url("public/images/loan_req/nic/front") . "/" . $data->nic_front : base_url("public/images") . "/no-image.png" ?>" height="150">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="nic_back_img" alt="" data-src="<?= isset($data->nic_back) ? base_url("public/images/loan_req/nic/back") . "/" . $data->nic_back : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="photo_img" alt="" data-src="<?= isset($data->photo) ? base_url("public/images/member") . "/" . $data->photo : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="bank_statement_img" alt="" data-src="<?= isset($data->bank_statement) ? base_url("public/images/loan_req/bank_statement") . "/" . $data->bank_statement : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="hw_nic_front_img" alt="" data-src="<?= isset($data->hw_nic_front) ? base_url("public/images/loan_req/nic/hw_nic_front") . "/" . $data->hw_nic_front : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="hw_nic_back_img" alt="" data-src="<?= isset($data->hw_nic_back) ? base_url("public/images/loan_req/nic/hw_nic_back") . "/" . $data->hw_nic_back : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="ga_certificate_img" alt="" data-src="<?= isset($data->ga_certificate) ? base_url("public/images/loan_req/ga_certificate") . "/" . $data->ga_certificate : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="fb_screenshot_img" alt="" data-src="<?= isset($data->fb_screenshot) ? base_url("public/images/loan_req/fb_screenshot") . "/" . $data->fb_screenshot : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                ...
                                <img id="electricity_bill_img" alt="" data-src="<?= isset($data->electricity_bill) ? base_url("public/images/loan_req/electricity_bill") . "/" . $data->electricity_bill : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                ...
                                <img id="selfie_img" alt="" data-src="<?= isset($data->selfie) ? base_url("public/images/loan_req/selfie") . "/" . $data->selfie : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
