                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="nic_back_img" alt="" src="<?= isset($data) ? base_url("public/images/loan_req/nic/back") . "/" . $data->nic_back : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="photo_img" alt="" src="<?= isset($data) ? base_url("public/images/member") . "/" . $data->photo : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="bank_statement_img" alt="" src="<?= isset($data) ? base_url("public/images/loan_req/bank_statement") . "/" . $data->bank_statement : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                ...
                                <img id="hw_nic_back_img" alt="" src="<?= isset($data) ? base_url("public/images/loan_req/nic/hw_nic_back") . "/" . $data->hw_nic_back : base_url("public/images") . "/no-image.png" ?>" height="150">
                                <div style="font: 13px Verdana; background: #eee; color: #333">
