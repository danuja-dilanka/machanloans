                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="row col-md-12">
                            ...
                            <div class="col-md-3">
                                <img src="<?= isset($member->photo) && $member->photo != "" ? base_url("public/images/member/") . $member->photo : base_url("public/uploads/profile/") . "default.png" ?>" class="thumb-image-md" width="100">
