                ...
                <li>
                    <div class="user-profile">
                        <h4 class="user-name dropdown-toggle" data-toggle="dropdown">
                            <img class="avatar user-thumb" id="my-profile-img" src="https://machan.quicksoft.lk/public/uploads/profile/profile_1677691803.png" alt="avatar"> Admin <i class="fa fa-angle-down"></i>
                        </h4>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="https://machan.quicksoft.lk/profile/edit"><i class="ti-pencil text-muted mr-2"></i>&nbsp;Profile Settings</a>
