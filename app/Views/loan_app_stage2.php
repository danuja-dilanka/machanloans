                                                ...
                                                <div class="form-group text-center">
                                                    ...
                                                    <div style="font: 13px Verdana; background: #eee; color: #333">
                                                        ...
                                                        <div id="file_container" style="position: relative;">
                                                            <a class="btn btn-danger btn-lg btn-block" id="pickfiles" href="javascript:;" style="position: relative; z-index: 1;text-decoration: none" data-src="<?= base_url("public/images/loan_req/loan_proof") ?>" data-id="bank_slip"><?= $lng == 'si' ? "තෝරන්න" : "Select" ?></a> 
