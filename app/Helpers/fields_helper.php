    ...
    <div class="form-group">
        ...
        <div class="radio radio-primary radio-inline">
            <input type="radio" id="y_opt_1_<?php echo $label; ?>" name="settings[<?php echo $option_value; ?>]"
                   value="<?php echo $replace_1 == '' ? 1 : $replace_1; ?>" <?php
                   if (get_option($option_value) == ($replace_1 == '' ? '1' : $replace_1)) {
                       echo 'checked';
                   }
                   ?>>
        ...
        <div class="radio radio-primary radio-inline">
            <input type="radio" id="y_opt_2_<?php echo $label; ?>" name="settings[<?php echo $option_value; ?>]"
                   value="<?php echo $replace_0 == '' ? 0 : $replace_0; ?>" <?php
                   if (get_option($option_value) == ($replace_0 == '' ? '0' : $replace_0)) {
                       echo 'checked';
                   }
                   ?>>
...
function render_input($name, $label = '', $value = '', $type = 'text', $input_attrs = [], $form_group_attr = [], $form_group_class = '', $input_class = '') {
    ...
    $req_sys = "";
    if (array_key_exists("required", $input_attrs)) {
        $req_sys = "* ";
    }
...
function render_textarea($name, $label = '', $value = '', $textarea_attrs = [], $form_group_attr = [], $form_group_class = '', $textarea_class = '') {
    ...
    $req_sys = "";
    if (array_key_exists("required", $textarea_attrs)) {
        $req_sys = "* ";
    }
...
function render_select($name, $options, $option_attrs = [], $label = '', $selected = '', $select_attrs = [], $form_group_attr = [], $form_group_class = '', $select_class = '', $include_blank = true) {
    ...
    $req_sys = "";
    if (array_key_exists("required", $select_attrs)) {
        $req_sys = "* ";
    }
    ...
    if (!isset($select_attrs['data-none-selected-text'])) {
        $select_attrs['data-none-selected-text'] = _l('Select Option');
    }
...
if (!function_exists('custom_select')) {
    ...
    function render_custom_select($name, $options, $label, $selected = '', $sel_attr = "") {

        $req_sys = "";
        if (str_contains($sel_attr, 'required')) {
            $req_sys = "* ";
        }
