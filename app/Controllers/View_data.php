...
//                (has_permission("loan_pay", "edit") ? "<a href='".base_url("loan/loan/").$key_enc."' class='btn btn-sm btn-primary'>Edit</a>&nbsp;" : "").
                (($value->status == 0 && has_permission("loan_pay", "edit")) ? "<a href='#' data-id='" . base_url("loan/loan_pay_approve/") . $key_enc . "' class='btn btn-sm btn-primary confirm_red_btn' data-callback='no_func'>Approve</a>&nbsp;" : "") .
                (($value->status == 0 && has_permission("loan_pay", "edit")) ? "<a href='#' data-id='" . base_url("loan/loan_pay_reject/") . $key_enc . "' class='btn btn-sm btn-warning confirm_red_btn' data-callback='no_func'>Reject</a>&nbsp;" : "") .
