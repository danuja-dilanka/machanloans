        ...
        foreach ($members as $key => $value) {
            ...
            $dropdown = '<div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink' . $key . '">
                  ...
                  ' . ("<button type='button' data-rate_des='".$value->rate_des."' data-rate='".$value->rate."' onclick='open_rating(this)' data-key='" . $key_enc . "' data-type='rating' class='dropdown-item'>Rate</button>") . '
